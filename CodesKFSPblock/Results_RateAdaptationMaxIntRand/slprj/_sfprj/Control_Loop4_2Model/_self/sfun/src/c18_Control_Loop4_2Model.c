  ...
  (SFc18_Control_Loop4_2ModelInstanceStruct *chartInstance)
{
  ...
  c18_Vlth = -0.24439000000000002;
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 17);
  c18_Vdth = -0.24439000000000002;
  ...
  chartInstance, uint32_T c18_b)
{
  ...
  if (chartInstance->c18_current_period_4_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'current_period_4\' (#207) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c18_b)
{
  ...
  if (chartInstance->c18_last_adaptation_4_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'last_adaptation_4\' (#209) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c18_b)
{
  ...
  if (chartInstance->c18_period_index_4_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'period_index_4\' (#202) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c18_b)
{
  ...
  if (chartInstance->c18_tau_4_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'tau_4\' (#208) in the initialization routine of the chart.\n");
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3236872823U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(304175702U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1009431086U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1310635996U);
}
...
mxArray *sf_c18_Control_Loop4_2Model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("iV8pEO5046CS1TG3tpwplC");
...
static void mdlSetWorkWidths_c18_Control_Loop4_2Model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3109045339U));
  ssSetChecksum1(S,(480744593U));
  ssSetChecksum2(S,(2770483355U));
  ssSetChecksum3(S,(1866781854U));
