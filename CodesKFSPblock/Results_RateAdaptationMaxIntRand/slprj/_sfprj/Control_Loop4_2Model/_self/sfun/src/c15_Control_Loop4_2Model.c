  ...
  chartInstance, uint32_T c15_b)
{
  ...
  if (chartInstance->c15_current_period_2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'current_period_2\' (#162) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c15_b)
{
  ...
  if (chartInstance->c15_last_adaptation_2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'last_adaptation_2\' (#164) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c15_b)
{
  ...
  if (chartInstance->c15_period_index_2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'period_index_2\' (#157) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c15_b)
{
  ...
  if (chartInstance->c15_tau_2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'tau_2\' (#163) in the initialization routine of the chart.\n");
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3864902217U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3417081520U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2252150788U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2065710616U);
}
...
mxArray *sf_c15_Control_Loop4_2Model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VE9pbxyMrdkOPiq1ylBIvB");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,353,368,746,1513);
        _SFD_CV_INIT_EML_IF(0,1,1,415,432,-1,745);
        _SFD_CV_INIT_EML_IF(0,1,2,441,499,-1,737);
        _SFD_CV_INIT_EML_IF(0,1,3,746,811,1370,1513);
        _SFD_CV_INIT_EML_IF(0,1,4,816,843,1072,1158);
        _SFD_CV_INIT_EML_IF(0,1,5,1072,1158,-1,1158);

        {
          static int condStart[] = { 755, 771 };

          static int condEnd[] = { 765, 809 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,754,810,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 1081, 1110 };

          static int condEnd[] = { 1104, 1156 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,1080,1157,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c15_Control_Loop4_2Model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3225587348U));
  ssSetChecksum1(S,(4284511744U));
  ssSetChecksum2(S,(4289300254U));
  ssSetChecksum3(S,(1365289412U));
