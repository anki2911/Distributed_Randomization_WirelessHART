  ...
  (SFc16_Control_Loop4_2ModelInstanceStruct *chartInstance)
{
  ...
  c16_Vlth = -0.24439000000000002;
  _SFD_EML_CALL(0U, chartInstance->c16_sfEvent, 17);
  c16_Vdth = -0.24439000000000002;
      ...
      if (CV_EML_COND(0, 1, 1, c16_get_current_period_3(chartInstance, 0) >
        ...
        if (CV_EML_IF(0, 1, 4, c16_get_last_adaptation_3(chartInstance, 0) ==
          ...
          if (CV_EML_COND(0, 1, 2, c16_get_last_adaptation_3(chartInstance, 0) ==
            ...
            c16_a = c16_c;
            c16_e_b = c16_Vxt0_1;
            c16_b_y = c16_a * c16_e_b;
            if (CV_EML_COND(0, 1, 3, c16_Vxt > c16_b_y)) {
...
const mxArray *sf_c16_Control_Loop4_2Model_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c16_nameCaptureInfo, sf_mex_createstruct("structure", 2, 19, 1),
                FALSE);
...
static void c16_info_helper(const mxArray **c16_info)
{
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 3);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("rdivide"), "name", "name", 3);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 6);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("eml_div"), "name", "name", 6);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("mpower"), "name", "name", 7);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 10);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("power"), "name", "name", 10);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 14);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("floor"), "name", "name", 14);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
  ...
  chartInstance, uint32_T c16_b)
{
  ...
  if (chartInstance->c16_current_period_3_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'current_period_3\' (#177) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c16_b)
{
  ...
  if (chartInstance->c16_last_adaptation_3_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'last_adaptation_3\' (#179) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c16_b)
{
  ...
  if (chartInstance->c16_period_index_3_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'period_index_3\' (#172) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c16_b)
{
  ...
  if (chartInstance->c16_tau_3_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'tau_3\' (#178) in the initialization routine of the chart.\n");
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1901759917U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(887808259U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(198739888U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1427689990U);
}
...
mxArray *sf_c16_Control_Loop4_2Model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("R8JSBdGkhnfuG8g45T53zF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1586);
        _SFD_CV_INIT_EML_IF(0,1,0,352,367,745,1512);
        _SFD_CV_INIT_EML_IF(0,1,1,414,431,-1,744);
        _SFD_CV_INIT_EML_IF(0,1,2,440,498,-1,736);
        _SFD_CV_INIT_EML_IF(0,1,3,745,810,1369,1512);
        _SFD_CV_INIT_EML_IF(0,1,4,815,842,1071,1157);
        _SFD_CV_INIT_EML_IF(0,1,5,1071,1157,-1,1157);

        {
          static int condStart[] = { 754, 770 };

          static int condEnd[] = { 764, 808 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,753,809,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 1080, 1109 };

          static int condEnd[] = { 1103, 1155 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,1079,1156,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c16_Control_Loop4_2Model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(637575984U));
  ssSetChecksum1(S,(4081324907U));
  ssSetChecksum2(S,(1451245732U));
  ssSetChecksum3(S,(593006440U));
