...
implementation 
{
    ...
    event void Timer2.fired()
    {
		if (TOS_NODE_ID == 7)
		{
			atomic
            {
				if (Buffer2[1] >= 0 && Buffer2[1] < 1000)
				{
					DAC12_0DAT = Buffer1[1];
					DAC12_1DAT = Buffer2[1];
				}
			}
        }
		else if (TOS_NODE_ID == 8)
		{
			atomic
            {
				if (Buffer2[2] >= 1000 && Buffer2[2] < 2000)
				{
					DAC12_0DAT = Buffer1[2];
					DAC12_1DAT = Buffer2[2];
				}
            }
        }
		else if (TOS_NODE_ID == 9)
		{
			atomic
            {
				if (Buffer2[3] >= 2000 && Buffer2[3] < 3000)
				{
					DAC12_0DAT = Buffer1[3];
					DAC12_1DAT = Buffer2[3];
				}
            }
        }
		else if (TOS_NODE_ID == 10)
		{
			atomic
            {
				if (Buffer2[4] >= 0 && Buffer2[4] < 4000)
				{
					DAC12_0DAT = Buffer1[4];
					DAC12_1DAT = Buffer2[4];
				}
            }
        }
