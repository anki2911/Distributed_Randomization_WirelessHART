  ...
  chartInstance, uint32_T c17_b)
{
  ...
  if (chartInstance->c17_current_period_1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'current_period_1\' (#1104) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c17_b)
{
  ...
  if (chartInstance->c17_last_adaptation_1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'last_adaptation_1\' (#1106) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c17_b)
{
  ...
  if (chartInstance->c17_period_index_1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'period_index_1\' (#1099) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c17_b)
{
  ...
  if (chartInstance->c17_tau_1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'tau_1\' (#1105) in the initialization routine of the chart.\n");
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2291208145U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1138504952U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3426854138U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(777251228U);
}
...
mxArray *sf_c17_Control_Loop4_2Model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("GXnbKtdTZ0SkNbTpIR8uVD");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1856);
        _SFD_CV_INIT_EML_IF(0,1,0,382,397,779,1741);
        _SFD_CV_INIT_EML_IF(0,1,1,426,443,-1,778);
        _SFD_CV_INIT_EML_IF(0,1,2,452,510,-1,770);
        _SFD_CV_INIT_EML_IF(0,1,3,779,844,1599,1741);
        _SFD_CV_INIT_EML_IF(0,1,4,883,910,1207,1293);
        _SFD_CV_INIT_EML_IF(0,1,5,1207,1293,-1,1293);

        {
          static int condStart[] = { 788, 804 };

          static int condEnd[] = { 798, 842 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,787,843,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 1216, 1245 };

          static int condEnd[] = { 1239, 1291 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,1215,1292,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c17_Control_Loop4_2Model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(470798751U));
  ssSetChecksum1(S,(2513441613U));
  ssSetChecksum2(S,(4245077461U));
  ssSetChecksum3(S,(3625545453U));
