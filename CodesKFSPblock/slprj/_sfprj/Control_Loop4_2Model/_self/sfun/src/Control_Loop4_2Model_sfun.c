  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2904884686U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3036132751U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(206133124U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2214259492U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3264794669U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2527199244U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4103393408U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2565455613U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 15:
      {
        if (strcmp(aiChksum, "SRie1tO1RUHrBhP8YsryF") == 0) {
     ...
     case 16:
      {
        if (strcmp(aiChksum, "H2LnJjROISVi9GSSS0lYhH") == 0) {
     ...
     case 17:
      {
        if (strcmp(aiChksum, "GXnbKtdTZ0SkNbTpIR8uVD") == 0) {
     ...
     case 18:
      {
        if (strcmp(aiChksum, "OZgzqSJtBT6AeZEUoLGEZF") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 15:
      {
        if (strcmp(tpChksum, "CAsfGv9dGrvRvJDxTWOpfC") == 0) {
     ...
     case 16:
      {
        if (strcmp(tpChksum, "9ic91EMMPnujCNK5vCk5DG") == 0) {
     ...
     case 17:
      {
        if (strcmp(tpChksum, "CQroihdUOIuE1OnTRmIJZC") == 0) {
     ...
     case 18:
      {
        if (strcmp(tpChksum, "T7kGIe3J21H3JRppYCAfW") == 0) {
  ...
  debugInstance)
{
  _Control_Loop4_2ModelMachineNumber_ = sf_debug_initialize_machine
    (debugInstance,"Control_Loop4_2Model","sfun",0,17,0,0,0);
