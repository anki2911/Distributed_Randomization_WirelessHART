  ...
  *chartInstance, uint32_T c13_b)
{
  ...
  if (chartInstance->c13_P_k_3_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P_k_3\' (#113) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c13_b)
{
  ...
  if (chartInstance->c13_X_k_3_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'X_k_3\' (#115) in the initialization routine of the chart.\n");
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2986430262U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2149188574U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2684124238U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(502722048U);
}
...
mxArray *sf_c13_Control_Loop4_2Model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("z36hvNHgdFBfDNUUs3b9MF");
...
static void mdlSetWorkWidths_c13_Control_Loop4_2Model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1039943404U));
  ssSetChecksum1(S,(1076263405U));
  ssSetChecksum2(S,(4078383858U));
  ssSetChecksum3(S,(252828415U));
