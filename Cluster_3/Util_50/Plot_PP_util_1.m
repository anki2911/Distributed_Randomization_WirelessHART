F1 = fopen('PP_Slot_50.txt','r');
Data_1 = fscanf(F1,'%f',[60 inf]);
F2 = fopen('PP_Slot_50_2_7.txt','r');
Data_2 = fscanf(F2,'%f',[60 inf]);
F3 = fopen('PP_Slot_50_12_6.txt','r');
Data_3 = fscanf(F3,'%f',[60 inf]);
F4 = fopen('PP_Slot_50_22_5.txt','r');
Data_4 = fscanf(F4,'%f',[60 inf]);
F5 = fopen('PP_Slot_50_32_4.txt','r');
Data_5 = fscanf(F5,'%f',[60 inf]);
F6 = fopen('PP_Slot_50_42_3.txt','r');
Data_6 = fscanf(F6,'%f',[60 inf]);
F7 = fopen('PP_Slot_50_52_2.txt','r');
Data_7 = fscanf(F7,'%f',[60 inf]);
F8 = fopen('PP_Slot_50_62_1.txt','r');
