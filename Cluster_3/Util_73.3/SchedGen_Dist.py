...
def main():
    ...
    for i in range(100):
        ...
        empty_1 = int(util_1*(hyperperiod - util_1 - util_2 - util_3)/(util_1 + util_2 + util_3))
        empty_2 = int(util_2*(hyperperiod - util_1 - util_2 - util_3)/(util_1 + util_2 + util_3))
        empty_3 = int(hyperperiod - (util_1 + util_2 + util_3 + empty_1 + empty_2))
