F1 = fopen('Divergence_SlotSwapper_75.txt','r');
Data_1 = fscanf(F1,'%f');
F2 = fopen('Divergence_Dist_2_7.txt','r');
Data_2 = fscanf(F2,'%f');
F3 = fopen('Divergence_Dist_12_6.txt','r');
Data_3 = fscanf(F3,'%f');
F4 = fopen('Divergence_Dist_22_5.txt','r');
Data_4 = fscanf(F4,'%f');
F5 = fopen('Divergence_Dist_32_4.txt','r');
Data_5 = fscanf(F5,'%f');
F6 = fopen('Divergence_Dist_42_3.txt','r');
Data_6 = fscanf(F6,'%f');
F7 = fopen('Divergence_Dist_52_2.txt','r');
Data_7 = fscanf(F7,'%f');
F8 = fopen('Divergence_Dist_62_1.txt','r');
Data_8 = fscanf(F8,'%f');
fclose(F1);
fclose(F2);
fclose(F3);
...
%title('Upper-bound K-L divergence at 75% slot utilization','fontweight','bold','fontsize',16);
